...
# Whoever is using nodenv need to follow the following steps to install
# a system level nodejs & npm otherwise you won't be able to change any of
# the /usr/lib/slack/ files (you'll get EACCES: permission denied errors`):
#
